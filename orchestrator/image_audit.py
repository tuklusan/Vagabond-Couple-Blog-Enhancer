...
_PROMPT = (
    ...
    "PRESERVE THE AUTHOR'S VOICE: if the original text has humor, wordplay, or a "
    "personal tone that is still compatible with what the frame shows, carry that "
    "tone into the correction instead of replacing it with a flat literal "
    "description -- fix only the factual mismatch, not the personality. "
